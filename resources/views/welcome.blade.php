        ...
        <div class="p-6 md:p-8 bg-gradient-to-b from-white to-sage/20 grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div class="relative dev-card bg-gradient-to-br from-sage to-white rounded-2xl p-5 text-center border border-emerald-100 hover:shadow-lg hover:shadow-primary/15 transition-all duration-300 hover:-translate-y-1">
                ...
                <div class="mt-2 flex justify-center">
                    <span data-i18n="dev_specialty_1" class="inline-block max-w-full whitespace-normal text-center bg-primary/10 text-primary text-xs px-3 py-1 rounded-full font-medium">Frontend & Interactive Content</span>
                </div>
            </div>
            <!-- Developer 2 -->
            <div class="relative dev-card bg-gradient-to-br from-sage to-white rounded-2xl p-5 text-center border border-emerald-100 hover:shadow-lg hover:shadow-primary/15 transition-all duration-300 hover:-translate-y-1">
                ...
                <p data-i18n="dev_role" class="text-xs text-emerald-600/70 mt-1">Developer</p>
                <div class="mt-2 flex justify-center">
                    <span data-i18n="dev_specialty_2" class="inline-block max-w-full whitespace-normal text-center bg-primary/10 text-primary text-xs px-3 py-1 rounded-full font-medium">Lead Developer & System Integration</span>
                </div>
            </div>
            <!-- Developer 3 -->
            <div class="relative dev-card bg-gradient-to-br from-sage to-white rounded-2xl p-5 text-center border border-emerald-100 hover:shadow-lg hover:shadow-primary/15 transition-all duration-300 hover:-translate-y-1">
                ...
                <p data-i18n="dev_role" class="text-xs text-emerald-600/70 mt-1">Developer</p>
                <div class="mt-2 flex justify-center">
                    <span data-i18n="dev_specialty_3" class="inline-block max-w-full whitespace-normal text-center bg-primary/10 text-primary text-xs px-3 py-1 rounded-full font-medium">Procedure Content & Campaign Design</span>
                </div>
            </div>
            <!-- Developer 4 -->
            <div class="relative dev-card bg-gradient-to-br from-sage to-white rounded-2xl p-5 text-center border border-emerald-100 hover:shadow-lg hover:shadow-primary/15 transition-all duration-300 hover:-translate-y-1">
                ...
                <p data-i18n="dev_role" class="text-xs text-emerald-600/70 mt-1">Developer</p>
                <div class="mt-2 flex justify-center">
                    <span data-i18n="dev_specialty_4" class="inline-block max-w-full whitespace-normal text-center bg-primary/10 text-primary text-xs px-3 py-1 rounded-full font-medium">Brand Story & Media Content</span>
                </div>
            </div>
        </div>
        <!-- Modal Footer -->
